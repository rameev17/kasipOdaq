            ...
            <div className='discussion-direction content'>
                ...
                <div className={'panel'}>
...

                            {
                                this.props.testStore.questions.map((question, index) => {
                                    return <div className={'test-question'}>
                                        ...
                                        <p onClick={() => this.props.testStore.addAnswer(index, question.resource_id)} ><AnswerAdd/>{this.props.userStore.languageList["Добавить ответ"] || 'Добавить ответ'}</p>

                                        <p> <QuestionInform/>{this.props.userStore.languageList["Можно добавить не более 10 вариантов ответа"] || 'Можно добавить не более 100 вариантов ответа'}</p>

                                    </div>
                                })
                            }

                            <p onClick={() => this.props.testStore.addQuestion()}><AnswerAdd/>{this.props.userStore.languageList["Добавить вопрос"] || 'Добавить вопрос'}</p>
                    ...
                    <div className={'test-buttons'}>
                        ...
                        <Link onClick={this.editTest} >{this.props.userStore.languageList["Сохранить"] || 'Сохранить'}</Link>
                    </div>
