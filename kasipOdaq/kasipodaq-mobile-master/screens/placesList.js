...
class PlacesListScreen extends React.Component {
    constructor(props) {
        super(props);
                    ...
                    <View style={styles.card}>
                        {
                            this.state.placesList.map((place, index) => {
                                return <View style={{
                                    ...
                                    <TouchableOpacity onPress = {() => this.props.navigation.navigate("create", { placeId: place.resource_id, placeName: place.name })} >
                                        <Text style={{
                                            color: "#2E384D",
                                            fontSize: 16,
                                            lineHeight: 24,
