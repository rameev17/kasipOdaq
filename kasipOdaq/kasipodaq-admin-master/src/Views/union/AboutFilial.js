...
class AboutFilial extends Component {
            ...
            <div className='opo-info opo-wrapper'>
                            ...
                            <div style={{ display: 'flex' }}>
                                {this.props.match.params.id !== 'undefined' && this.props.match.params.id !== undefined ?
                                    <Link className='edit-ppo' to={{
                                        pathname: `/union/filial/${this.props.match.params.id}/edit`,
                                        state: {tabId: 1}
                                    }}
                                    >
                                        <div className="btn-action">
                                    ...
                                    :
                                    <Link className='edit-ppo' to={{
                                        pathname: `/union/filial/${this.props.userStore.profile.union.resource_id}/edit`,
                                        state: {tabId: 1}
                                    }}
                                    >
                                        <div className="btn-action">
                ...
                <div className="container">
                    ...
                    <div className="about-union">
                        <p className="subtitle">
                            {this.props.userStore.languageList["О филиале"] || 'О филиале'}
                        </p>
...
export default inject('unionStore', 'permissionsStore', 'userStore')(observer(AboutFilial));