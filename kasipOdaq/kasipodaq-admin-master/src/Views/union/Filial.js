        ...
        switch (tab) {
            case '1':
                this.props.history.push({
                    pathname:`/union/filial/${this.props.match.params.id}`,
                    state: { tabId: 1 }
                });
                break;
            case '2':
                this.props.history.push({
                    pathname:`/union/filial/${this.props.match.params.id}/ppo`,
                    state: { tabId: 2 }
                });
                break;
            default:
                        ...
                        <Switch>
                            {
                                ...
                                <Route exact path='/union'
                                       render={props => (<AboutFilial {...props} />)}/>
                            }
                            ...
                            <Route exact path='/union/reports/:id'
                                   render={props => (
                                       <ReportCreate {...props} />)}/>
                            <Route exact path='/union/filial/:id' render={props => (<AboutFilial {...props}/>)}/>
                            <Route exact path='/union/filial/:id/ppo' render={props => (<FilialPpoList {...props}/>)}/>
                            ...
                            <Route exact path='/union/filial/:id/edit' render={props => (<PpoEdit {...props}/>)}/>
...
export default withRouter(inject('unionStore', 'permissionsStore', 'userStore')(observer(Filial)));