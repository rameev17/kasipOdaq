...
const Opo = inject('newsStore', 'permissionsStore', 'userStore', 'unionStore')(observer(class Opo extends Component {
    ...
    constructor(props){
        ...
        this.nextPageUnions = this.nextPageUnions.bind(this);
        this.prevPageUnions = this.prevPageUnions.bind(this);
        this.changeTabCallback = this.changeTabCallback.bind(this);
        this.loadUnions = this.loadUnions.bind(this);
        this.searchNews = this.searchNews.bind(this);
        this.searchUnionsPpo = this.searchUnionsPpo.bind(this)
    }
                    ...
                    <div className={"" + (this.role !== 'rManagerOpo' ? 'panel' : '')}>
                        <TabsLayout changeTabCallback={this.changeTabCallback}
                            ...
                            <Search
                                ...
                                search={this.searchUnionsPpo}
                                prevPage={this.prevPageUnions}
                                nextPage={this.nextPageUnions}
                            />
                            <ul className="list__wrapper">
                                {
