...
class FilialPpoList extends Component {
                ...
                <ul className="list__wrapper">
                    {
                        this.props.unionStore.unionsPpoList.map(union => (
                            <li key={union.resource_id}>
                                <Link to={`/union/ppo/` + union.resource_id}>
                                    <div className="icon">
                                        <FolderIcon/>
                                    </div>
                                    { union.name }
...
export default inject('unionStore', 'permissionsStore', 'userStore')(observer(withRouter(FilialPpoList)));