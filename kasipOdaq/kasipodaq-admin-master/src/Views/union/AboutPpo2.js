...
class AboutPpo2 extends Component {
        ...
        return (
            <div className='opo-info opo-wrapper'>
                ...
                <div className="heading">
                    ...
                    <div className="links">
                        {
                            this.props.userStore.role == 'industry' || this.props.userStore.role == 'company' ?
                            ...
                            <div style={{ display: 'flex' }}>
                                {this.props.match.params.id !== 'undefined' && this.props.match.params.id !== undefined ?
                                    <Link className='edit-ppo' to={{
                                        pathname: `/union/ppo2/${this.props.match.params.id}/edit`,
                                        state: {tabId: 1}
                                    }}
                                    >
                                        <div className="btn-action">
                                    ...
                                    :
                                    <Link className='edit-ppo' to={{
                                        pathname: `/union/ppo2/${this.props.userStore.profile.union.resource_id}/edit`,
                                        state: {tabId: 1}
                                    }}
                                    >
                                        <div className="btn-action">
...
export default inject('unionStore', 'permissionsStore', 'userStore')(observer(AboutPpo2));