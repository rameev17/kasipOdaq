...
class RequestsList extends Component {
    ...
    loadAppeals(){
        this.props.appealStore.loadAppeals(3,null,null, () => {
    ...
    searchAppeal(search){
        if (search.length > 2){
            this.setState({ preloader: true })
            this.props.appealStore.loadAppeals(3,search,null,() => {
                this.setState({ preloader: false })
            }, response => {
                if (Array.isArray(response.data)) {
                    response.data.forEach(error => {
                            ...
                            return <tr className='not-answered' key={index}>
                                ...
                                </td>
                                {
                                    ...
                                    <td className="answer accept">
                                        <Link to={`/law-requests/request/` + appeal.resource_id}>
