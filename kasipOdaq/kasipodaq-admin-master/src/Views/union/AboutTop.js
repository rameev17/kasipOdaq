            ...
            <div className='opo-info opo-wrapper'>
                            ...
                            <div style={{ display: 'flex' }}>
                                {this.props.match.params.id !== 'undefined' && this.props.match.params.id !== undefined ?
                                    <Link className='edit-ppo' to={{
                                        pathname: `/union/top/${this.props.match.params.id}/edit`,
                                        state: {tabId: 1}
                                    }}
                                    >
                                        <div className="btn-action">
                                    ...
                                    :
                                    <Link className='edit-ppo' to={{
                                        pathname: `/union/top/${this.props.userStore.profile.union.resource_id}/edit`,
                                        state: {tabId: 1}
                                    }}
                                    >
                                        <div className="btn-action">
                ...
                <div className="container">
                    ...
                    <div className="about-union">
                        ...
                        {/*    <span className="subtitle">Документы</span>*/}
...
export default inject('unionStore', 'permissionsStore', 'userStore')(observer(AboutTop));