...
class RequestToFprkScreen extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            requests: [],
    ...
    refreshScreen = () => {
      ...
      this.loadRequests(data => this.setState({requests: data, refreshing: false}));
    }
...
export default RequestToFprkScreen;
