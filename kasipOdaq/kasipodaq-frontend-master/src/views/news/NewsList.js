...
class NewsList extends Component {
    ...
    componentDidMount() {
        this.setState({ preloader: true }, () => {
            this.props.userStore.profileInfo(() => {
                this.props.newsStore.loadAllNews(this.props.userStore.profile.union.resource_id, this.state.count,null, () => {
    ...
    searchNews(){
        if (this.searchRef.current.value.length >= 3){
            this.setState({ preloader: true })
            this.props.newsStore.loadAllNews(
                                ...
                                CookieService.get('token') ?
                                    ...
                                    >
                                        ...
                                        <Scrollbars style={{width: '100%', minHeight: 320, borderTop: '1px solid #E4E8F0' }}
                                            ...
                                            {
                                                this.props.newsStore.newsList.length > 0 &&
...
export default inject('newsStore', 'userStore', 'permissionsStore')(observer(NewsList));